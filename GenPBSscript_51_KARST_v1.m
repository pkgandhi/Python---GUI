function GenPBSscript_51_KARST_v1(DirPathLC,Email)
%09/11/2015
...
for i = 1:16:NoOfSubjs,
    ...
    if D(i).isdir == 1 & ~strcmp(D(i).name, 'PBSscripts_KT') & ~strcmp(D(i).name, 'MGZ_FILES'),
	    ...
	    fprintf(fid, 'module load freesurfer/5.1.0\n');
	    fprintf(fid, ['export SUBJECTS_DIR=' DirPathLC '\n']);
	    fprintf(fid, 'source /N/soft/cle4/freesurfer/5.1.0/FreeSurferEnv.sh\n\n');
