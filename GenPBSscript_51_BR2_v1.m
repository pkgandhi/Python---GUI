function GenPBSscript_51_BR2_v1(DirPathLC,Email)
%03/14/2016
...
for i = 1:32:NoOfSubjs,
    ...
    if D(i).isdir == 1 & ~strcmp(D(i).name, 'PBSscripts_BR2') & ~strcmp(D(i).name, 'MGZ_FILES'),
	    ...
	    fprintf(fidpbs, 'module load freesurfer/5.1.0\n');
	    fprintf(fidpbs, ['export SUBJECTS_DIR=' DirPathLC '\n']);
	    fprintf(fidpbs, 'source /N/soft/cle4/freesurfer/5.1.0/FreeSurferEnv.sh\n');
	    fprintf(fidpbs, '\n');
